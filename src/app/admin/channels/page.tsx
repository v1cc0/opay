...
function getTexts(locale: Locale) {
  return locale === 'en'
    ? {
        ...
        fieldGroupId: 'Platform Group ID',
        cancel: 'Cancel',
        save: 'Save',
        saving: 'Saving...',
        syncTitle: 'Sync from Platform',
        syncHint: 'Select groups to import as channels',
        syncLoading: 'Loading groups...',
        syncNoGroups: 'No groups found in the platform',
        ...
        syncFetchFailed: 'Failed to fetch platform groups',
