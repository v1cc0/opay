...
function OrdersContent() {
  ...
  const text = {
    ...
    visitOrders: pickLocaleText(locale, '请从平台入口正确访问订单页面', 'Please open the orders page from the platform entry'),
    sessionExpired: pickLocaleText(locale, '登录态已失效，请从平台入口重新进入支付页。', 'Session expired. Please re-enter from the platform entry.'),
    ...
    authError: pickLocaleText(locale, '缺少认证信息，请从平台入口正确访问订单页面', 'Missing authentication information. Please open the orders page from the platform entry.'),
